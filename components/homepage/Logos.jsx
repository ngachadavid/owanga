    ...
    <section className="bg-black text-white py-10 md:py-20 ">
      <div className="max-w-[1286px] mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-32">
          <img src="/logos/barfy.png" alt="Logo 1" className="h-16 md:h-20 w-auto" />
          <img src="/logos/logo2.png" alt="Logo 2" className="h-16 md:h-20 w-auto" />
          <img src="/logos/logo3.png" alt="Logo 3" className="h-16 md:h-20 w-auto" />
          <img src="/logos/logo4.png" alt="Logo 4" className="h-16 md:h-20 w-auto" />
